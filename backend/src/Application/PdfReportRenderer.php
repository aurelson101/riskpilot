...
final class PdfReportRenderer
{
    ...
    private function executiveDocument(string $title, array $data, string $locale): string
    {
        ...
        return '<!doctype html><html lang="'.$locale.'"><head><meta charset="UTF-8"><title>'.$this->escape($title).'</title><style>'.$css.'</style></head><body>'.
            ...
            '<h2>1. '.$this->t('Indicateurs exécutifs', 'Executive indicators', $locale).'</h2><table class="cards cards-three"><tr>'.$cardHtml.'</tr></table>'.
    ...
    {
        return '@page{margin:18mm 14mm 18mm}body{font-family:"DejaVu Sans",sans-serif;color:#17324d;font-size:9px;line-height:1.4}header{border-bottom:3px solid #0284c7;padding-bottom:10px;margin-bottom:13px}.brand,.title-table{width:100%;border:0;margin:0}.brand{margin-bottom:6px}.brand td,.title-table td{border:0;padding:0}.brand-name{font-size:13px;font-weight:bold;color:#075985}.classification{text-align:right;font-size:7px;letter-spacing:.5px;color:#475569}.doc-title{font-size:19px;color:#075985;margin:0 0 4px;line-height:1.2;word-wrap:break-word}.document-id{font-size:7px;color:#64748b;margin-top:2px}h2{font-size:14px;color:#075985;margin:17px 0 7px;page-break-after:avoid}h3{font-size:11px;color:#164e63;margin:11px 0 5px;page-break-after:avoid}.meta{color:#52677a}.cards{width:100%;border-collapse:separate;border-spacing:4px}.cards-three .card{width:33.33%}.card{border:1px solid #bae6fd;background:#f0f9ff;padding:7px;text-align:center;white-space:normal;word-wrap:break-word}.card strong{display:block;font-size:15px;color:#0369a1}.notice{background:#f8fafc;border-left:4px solid #38bdf8;padding:8px;margin:8px 0;page-break-inside:avoid}.warning{border-left-color:#f59e0b;background:#fffbeb}table{width:100%;table-layout:fixed;border-collapse:collapse;margin-bottom:9px}thead{display:table-header-group}tr{page-break-inside:avoid}th,td{border:1px solid #cbd5e1;padding:5px;vertical-align:top;white-space:normal;word-wrap:break-word;overflow-wrap:break-word}th{background:#eaf5fb;text-align:left;color:#164e63}.score{white-space:nowrap;width:58px}.meter{height:7px;background:#e2e8f0}.meter span{display:block;height:7px;background:#0284c7}.bar{height:6px;background:#e2e8f0;width:100px;display:inline-block;margin-right:5px}.bar span{display:block;height:6px;background:#38bdf8}.empty{color:#64748b;font-style:italic}.keep{page-break-inside:avoid}footer{position:fixed;bottom:-11mm;left:0;right:0;border-top:1px solid #d8e1e8;padding-top:4px;color:#64748b;font-size:7px}';
    }
