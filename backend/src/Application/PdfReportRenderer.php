...
final class PdfReportRenderer
{
    ...
    {
        return '@page{margin:18mm 14mm 18mm}body{font-family:"DejaVu Sans",sans-serif;color:#17324d;font-size:9px;line-height:1.45}header{border-bottom:3px solid #0284c7;padding:0 0 10px;margin-bottom:13px}.brand,.title-table{width:100%;border:0;margin:0}.brand{margin-bottom:6px}.brand td,.title-table td{border:0;padding:0}.brand-name{font-size:13px;font-weight:bold;color:#075985;letter-spacing:.4px}.classification{text-align:right;font-size:7px;letter-spacing:.7px;color:#475569}.doc-title{font-size:20px;color:#075985;margin:0 0 4px;line-height:1.2;word-wrap:break-word}.document-id{font-size:7px;color:#64748b;margin-top:2px}h2{font-size:14px;color:#075985;border-left:3px solid #38bdf8;padding-left:6px;margin:18px 0 8px;page-break-after:avoid}h3{font-size:11px;color:#164e63;margin:12px 0 5px;page-break-after:avoid}.meta{color:#52677a;background:#f8fafc;padding:6px 8px;border-left:2px solid #cbd5e1}.cards{width:100%;border-collapse:separate;border-spacing:4px}.card{border:1px solid #bae6fd;background:#f0f9ff;padding:8px;text-align:center}.card strong{display:block;font-size:16px;color:#0369a1}.notice{background:#f8fafc;border-left:4px solid #38bdf8;padding:8px;margin:10px 0;page-break-inside:avoid}.warning{border-left-color:#f59e0b;background:#fffbeb}table{width:100%;table-layout:fixed;border-collapse:collapse;margin-bottom:10px}thead{display:table-header-group}tr{page-break-inside:avoid}th,td{border:1px solid #cbd5e1;padding:6px;vertical-align:top;overflow-wrap:break-word}th{background:#eaf5fb;text-align:left;color:#164e63;font-weight:bold}.score{white-space:nowrap;width:58px}.meter{height:7px;background:#e2e8f0}.meter span{display:block;height:7px;background:#0284c7}.bar{height:6px;background:#e2e8f0;width:100px;display:inline-block;margin-right:5px}.bar span{display:block;height:6px;background:#38bdf8}.empty{color:#64748b;font-style:italic}.keep{page-break-inside:avoid}footer{position:fixed;bottom:-11mm;left:0;right:0;border-top:1px solid #d8e1e8;padding-top:4px;color:#64748b;font-size:7px}';
    }
    ...
    {
        return '<header><table class="brand" role="presentation"><tr><td><span class="brand-name">RISKpilot</span></td><td class="classification">'.$this->escape($classification).' · '.$this->escape($status).'</td></tr></table><table class="title-table" role="presentation"><tr><td><h1 class="doc-title">'.$this->escape($title).'</h1><div class="document-id">'.$this->escape($organization).' · ID '.$this->escape($documentId).'</div></td></tr></table>';
    }
