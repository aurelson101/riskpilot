...
{
    public const TYPES = ['TASK', 'RESPONSIBILITY_RULE', 'COMPLIANCE_PROGRAM', 'QUESTIONNAIRE_TEMPLATE', 'QUESTIONNAIRE_CAMPAIGN', 'REFERENCE_PACK', 'SECURITY_PROJECT', 'SAVED_VIEW', 'REPORT_TEMPLATE', 'REPORT_RUN', 'ANNUAL_REPORT', 'CONNECTOR_SYNC', 'TPRM_PROGRAM', 'P3_SETTINGS'];
